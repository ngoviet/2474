                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="city_id" id="city_id">
                                    ...
                                    @else
                                        @if(isset($cities))
                                            @foreach($cities as $city)
                                                <option value="{{{ Input::old('city_id', isset($city) ? $city->id : null) }}}">{{ $city->name }}</option>
                                            @endforeach : null
                                        @endif
                                    @endif
                                </select>
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="agency_id" id="agency_id">
                                    ...
                                    @else
                                        @if(isset($agencies))
                                            @foreach($agencies as $agency)
                                                <option value="{{ Input::old('agency_id', isset($agency) ? $agency->id : null) }}">{{ $agency->name }}</option>
                                            @endforeach
                                        @endif
                                    @endif
                                </select>
