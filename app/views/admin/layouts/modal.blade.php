...
<head id="Starter-Site">
	...
	<meta name="DC.title" content="2471">
    ...
    <link rel="stylesheet" href="{{asset('assets/bootstrap-wysihtml5-0.0.2/bootstrap-wysihtml5.css')}}">
...
<!--    <script src="{{asset('assets/js/wysihtml5/wysihtml5-0.3.0.js')}}"></script>-->
    <script src="{{asset('assets/bootstrap-wysihtml5-0.0.2/libs/js/wysihtml5-0.3.0_rc2.min.js')}}"></script>
    <script src="{{asset('assets/bootstrap-wysihtml5-0.0.2/bootstrap-wysihtml5.min.js')}}"></script>
